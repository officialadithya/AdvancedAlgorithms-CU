...
\input{Chapters/finegrained.tex}
...
\input{Chapters/matrixmultiplication.tex}
...
\input{Chapters/nphardgraph.tex}
...
\input{Chapters/metricembeddings.tex}

\begin{savequote}
    
\end{savequote}
\chapter{Number-Theoretic Cryptography and Algorithms}

\input{Chapters/crytography.tex}

\chapter*{}
\addcontentsline{toc}{chapter}{Algorithms as a Word Cloud}
...
\markboth{LIST OF THEOREMS AND DEFINITIONS}{LIST OF THEOREMS AND DEFINITIONS}
    ...
    \input{AutomaticThmsDefsIndex/listOfLabels.tex}
