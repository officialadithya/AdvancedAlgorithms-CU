...
\section{Lecture 4: January 23, 2025}
    ...
    \subsection{Smarter \(k\)-SAT, Part I}
        ...
        \begin{lemma}{\Stop\,\,The Sparsification Lemma}{sparsificationlemma}
        ...
        \\
        \\
        With the help of Lemma~\ref{lem:sparsificationlemma}, we can show that the ``strong'' exponential time hypothesis indeed implies the exponential time hypothesis.
        \adit{TODO! HW.}
